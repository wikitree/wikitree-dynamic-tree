...
export class LocationStatistics {
    ...
    this.peopleArray.forEach((person) => {
      ...
      if (correctedLocation !== birthLocation) {
        ...
        */
        ...
        if (correctedLocation.match(regex) || correctedLocation.match(regex2) || correctedLocation.match(regex3)) {
  ...
  isStandaloneLocationName(part) {
    return this.isCountryName(part) || this.isUSState(part) || this.isUKCounty(part) || this.isHistoricalCountry(part);
  }
